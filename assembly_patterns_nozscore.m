function AssemblyTemplates = assembly_patterns_nozscore(SpikeCount,opts)
...
if nargin<2
    opts.threshold.method = 'MarcenkoPastur';
    opts.Patterns.method = 'ICA';
    opts.Patterns.number_of_iterations = 2000;
end
...
switch opts.Patterns.method
    ...
    case 'ICA'
        AssemblyTemplates=...
            fast_ica(SpikeCount,NumberOfAssemblies,opts.Patterns.number_of_iterations);
